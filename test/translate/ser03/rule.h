...
CLASS(SER03)
	START_RULE(SER03)
		...
		NEW_START_STATE
		NEW_FINAL_STATE
		ADD_TRANSITION("start", "_ZN4java2io18ObjectOutputStreamC1EPNS0_12OutputStreamE", THIS_POINTER, 1, "s1", "")
		ADD_TRANSITION("s1", "_ZN4java2io18ObjectOutputStream11writeObjectEJvPNS_4lang6ObjectE", THIS_POINTER, NOT(IS_SENSITIVE_DATA(1)), "end", "SER03")
		ADD_TRANSITION("s1", "_ZN4java2io18ObjectOutputStream11writeObjectEJvPNS_4lang6ObjectE", THIS_POINTER, IS_SENSITIVE_DATA(1), "end", "")
		BUILD_END("SER03")
		RULE_INFO("SER03", "DEFAULT")
	END_RULE
END_CLASS
